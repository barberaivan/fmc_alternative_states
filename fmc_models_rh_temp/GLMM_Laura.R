...
sdata <- list(
  ...
  prior_mu_eta_sd = 1,
  prior_mu_lambda_sd = 2.5, # 2.5 if a spline is used, 1 for the linear term.
...
# stan_code <- stan_model("fmc_models/GLMM_Laura.stan", verbose = TRUE)
glm1 <- sampling(
